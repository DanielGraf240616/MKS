...
outputs:
- {id: CTIMER1_clock.outFreq, value: 299.703125/2 MHz}
...
- {id: SYSCON.MAINCLKSELB.sel, value: SYSCON.PLL0_BYPASS}
- {id: SYSCON.PLL0CLKSEL.sel, value: SYSCON.CLK_IN_EN}
- {id: SYSCON.PLL0M_MULT.scale, value: '2514092032'}
...
void BOARD_BootClockPLL1_150M(void)
{
    ...
    POWER_SetVoltageForFreq(149851562U);                  /*!< Set voltage for the one of the fastest clock outputs: System clock output */
    CLOCK_SetFLASHAccessCyclesForFreq(149851562U);          /*!< Set FLASH wait states for core */
    ...
    const pll_setup_t pll0Setup = {
        ...
        .pllndec = SYSCON_PLL0NDEC_NDIV(4U),
        .pllpdec = SYSCON_PLL0PDEC_PDIV(1U),
        .pllsscg = {(SYSCON_PLL0SSCG0_MD_LBS(2514092032U)),(SYSCON_PLL0SSCG1_MD_MBS(0U) | (uint32_t)(kSS_MF_512) | (uint32_t)(kSS_MR_K0) | (uint32_t)(kSS_MC_NOC))},
        .pllRate = 149851562U,
